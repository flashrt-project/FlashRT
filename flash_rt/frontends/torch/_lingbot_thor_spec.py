...
Verified against the baseline weight inventory (1555 tensors) —
see ``tests/test_lingbot_g4a_spec.py``:
...
def build_spec(*, num_vlm_layers: int = 36,
    ...
    tensors of ``robbyant/lingbot-vla-4b`` exactly (verified by
    ``tests/test_lingbot_g4a_spec.py``).
    """
